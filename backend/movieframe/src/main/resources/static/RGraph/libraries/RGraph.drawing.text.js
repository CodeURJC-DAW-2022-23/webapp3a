'version:2023-02-25 (6.11)';RGraph=window.RGraph||{isrgraph:true,isRGraph:true,rgraph:true};RGraph.Drawing=RGraph.Drawing||{};RGraph.Drawing.Text=function(conf)
{var id=conf.id
var x=conf.x;var y=conf.y;var text=String(conf.text);this.id=id;this.canvas=document.getElementById(id);this.context=this.canvas.getContext('2d');this.colorsParsed=false;this.canvas.__object__=this;this.x=x;this.y=y;this.text=String(text);this.coords=[];this.coordsText=[];this.original_colors=[];this.firstDraw=true;this.type='drawing.text';this.isRGraph=true;this.isrgraph=true;this.rgraph=true;this.uid=RGraph.createUID();this.canvas.uid=this.canvas.uid?this.canvas.uid:RGraph.createUID();this.properties={textSize:12,textFont:'Arial, Verdana, sans-serif',textBold:false,textItalic:false,text:null,angle:0,colors:['black'],highlightStroke:'#ccc',highlightFill:'rgba(255,255,255,0.5)',tooltips:null,tooltipsEffect:'slide',tooltipsCssClass:'RGraph_tooltip',tooltipsCss:null,tooltipsEvent:'onclick',tooltipsHighlight:true,tooltipsCoordsPage:false,tooltipsFormattedPoint:'.',tooltipsFormattedThousand:',',tooltipsFormattedDecimals:0,tooltipsFormattedUnitsPre:'',tooltipsFormattedUnitsPost:'',tooltipsFormattedListType:'ul',tooltipsFormattedListItems:null,tooltipsPointer:true,tooltipsPositionStatic:true,bounding:false,boundingFill:'rgba(255,255,255,0.7)',boundingStroke:'#777',boundingShadow:false,boundingShadowColor:'#ccc',boundingShadowBlur:3,boundingShadowOffsetx:3,boundingShadowOffsety:3,marker:false,halign:'left',valign:'bottom',link:null,linkTarget:'_self',linkOptions:'',textAccessible:false,textAccessibleOverflow:'visible',textAccessiblePointerevents:false,shadow:false,shadowColor:'#ccc',shadowOffsetx:2,shadowOffsety:2,shadowBlur:3,clearto:'rgba(0,0,0,0)'}
...
this.coords.push({0:ret.x,x:ret.x,1:ret.y,y:ret.y,2:ret.width,width:ret.width,3:ret.height,height:ret.height});RGraph.addCustomText(this);RGraph.installEventListeners(this);if(this.firstDraw){this.firstDraw=false;RGraph.fireCustomEvent(this,'onfirstdraw');this.firstDrawFunc();}
