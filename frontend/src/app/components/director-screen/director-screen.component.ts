...
export class DirectorScreenComponent {
  ...
  constructor(private router: Router, private activatedRoute: ActivatedRoute, public directorsService: DirectorsService) {
  }

  ngOnInit() {
    this.id = this.activatedRoute.snapshot.params['id'];
    this.directorsService.getDirector(this.id).subscribe(
