...
RGraph.drawBackgroundImage(this);RGraph.Background.draw(this);RGraph.addCustomText(this);RGraph.installEventListeners(this);if(this.firstDraw){this.firstDraw=false;RGraph.fireCustomEvent(this,'onfirstdraw');this.firstDrawFunc();}
