...
## **3. Permisos de los usuarios:**
  ...
  * **_Administrador_**:visualiza la cartelera, agrega/edita reseñas, vota películas o series, visualiza y comenta reseñas de otros registrados, visualizar el histórico de reseñas realizadas, eliminar reseñas de usuarios registrados, comentarios, información no verificada y añadir películas o series a la app.
...
## **7. Algoritmo avanzado:**
  * Usuario registrado:
    * _Si no ha publicado reseñas_: se le muestra la cartelera de películas y series más recientes (fecha más actual)
