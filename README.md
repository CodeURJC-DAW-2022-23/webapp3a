...
- se agregó una pantalla donde el administrador crea una nueva peli (rellena los campos para meter el títulos, descripción, imagen,...),
 - se agregó una pantalla donde un usuario puede generar un PDF con todas sus reseñas; para ello se usó una librería externa
- se posibilitó al administrador modificar info. textual de una película
- se permite a un usuario no registrado visualizar todas las reseñas exitentes en la pag. web
