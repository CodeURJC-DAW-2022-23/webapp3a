...
public class DataBaseInizialiter {
    ...
    public void init() throws IOException{
        ...
        //sample movies
        movie movie1 = new es.webapp3.movieframe.model.movie("Avatar", "James Cameron", "Sci-Fi", "Jake Sully vive con su nueva familia en el planeta de Pandora. Cuando una amenaza conocida regresa, Jake debe trabajar con Neytiri y el ejército de la raza na'vi para proteger su planeta.","https://www.youtube.com/embed/FSyWAxUg3Go");  
        setMovieImage(movie1,"/sample_images/uploads/slider1.jpg"); 
        setMovieImageTrailer(movie1,"/sample_images/uploads/trailer7.jpg"); 
        List<String> actors = new ArrayList<String>();
        actors.add("Robert Downey Jr As: Robert Downey Jr.");
        actors.add("Robert Downey Jr As: Robert Downey Jr.");
        actors.add("Robert Downey Jr As: Robert Downey Jr.");
        actors.add("Robert Downey Jr As: Robert Downey Jr.");
        actors.add("Robert Downey Jr As: Robert Downey Jr.");
    ...
    public void setMovieImageTrailer(movie movie, String classpathResource) throws IOException {
		movie.setImageTR(true);
		Resource image = new ClassPathResource(classpathResource);
		movie.setImageTrailer(BlobProxy.generateProxy(image.getInputStream(), image.contentLength()));
	}
