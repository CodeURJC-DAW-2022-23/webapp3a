...
{if(e.button===0){e.target.__object__.set('mousedown',true);var obj=e.target.__object__,properties=obj.properties
...
if(obj.type==='bar'&&properties.variant==='3d'){var adjustment=properties.variantThreedAngle*mouseXY[0];mouseY-=adjustment;}
...
{var obj=e.target.__object__;var properties=obj.properties;var mouseXY=RGraph.getMouseXY(e);var mouseX=mouseXY[0];var mouseY=mouseXY[1];var lastXY=RGraph.Registry.get('annotatable.last.coordinates');if(obj.get('mousedown')){if(obj.type==='bar'&&properties.variant==='3d'){var adjustment=properties.variantThreedAngle*mouseXY[0];mouseY-=adjustment;}
...
div.__object__=obj;div.className='RGraph_palette';div.style.position='absolute';div.style.backgroundColor='white';div.style.border='1px solid #999';div.style.left=0;div.style.top=0;div.style.padding='3px';div.style.paddingLeft='5px';div.style.opacity=0;div.style.boxShadow='rgba(48,48,48,0.25) 1px 1px 3px';div.style.WebkitBoxShadow='rgba(48,48,48,0.25) 1px 1px 3px';div.style.MozBoxShadow='rgba(48,48,48,0.25) 1px 1px 3px';var colors=['Black','Red','Yellow','Green','Orange','White','Magenta','Pink'];for(var i=0,len=colors.length;i<len;i+=1){var div2=doc.createElement('DIV');div2.cssClass='RGraph_palette_color';div2.style.fontSize='12pt';div2.style.cursor='pointer';div2.style.padding='1px';div2.style.paddingRight='10px';div2.style.textAlign='left';var span=document.createElement('SPAN');span.style.display='inline-block';span.style.marginRight='9px';span.style.width='17px';span.style.height='17px';span.style.top='2px';span.style.position='relative';span.style.backgroundColor=colors[i];div2.appendChild(span);div2.innerHTML+=colors[i];div2.onmouseover=function()
